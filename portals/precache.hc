...
void() W_Precache =
{
	...
	precache_model ("models/proj_ball.mdl");
	precache_file ("models/glowball.mdl");
...
//SHARED PLAYER SOUNDS
	...
	precache_sound ("player/decap2.wav");		// Decapitation sound 2
	...
	precache_sound ("assassin/rip.wav");		//SoC
	precache_sound ("assassin/chainwhip.wav"); 	//SoC
	...
	precache_sound ("fx/level.wav");		//Healing sound
...
//PALADIN
	...
	precache_model2 ("models/mumshot.mdl");	//SoC
...
//Body Sounds
	...
	//Meteor Staff
	precache_sound ("crusader/BOUNCE2.wav");	//SoC
...
//Weapon sounds
	...
	precache_sound ("weapons/ric2.wav");		//SoC
	//Scarab Staff
...
//	precache_sound4 ("succubus/firecirc.wav");
	...
	precache_sound4 ("raven/kiltorch.wav");		//SoC
	precache_sound4 ("misc/fburn_bg.wav");		//SoC
...
//	precache_model("models/bldspot3.spr");
	...
	precache_model ("models/eidoflam.spr");//purifier
...
void precache_afrit()
{
	precache_model ("models/afrit.mdl");
	precache_model ("models/afritwing.mdl");
	precache_model ("models/fireball2.mdl");
	
	precache_sound ("afrit/death.wav");
	precache_sound ("afrit/death2.wav");
	precache_sound ("afrit/atk.wav");
	precache_sound ("afrit/idle.wav");
	precache_sound ("afrit/pain.wav");
	precache_sound ("afrit/pain2.wav");
	precache_sound ("afrit/sight.wav");
	precache_sound ("afrit/hover.wav");
	precache_sound ("afrit/afrithit.wav");
}
...
void precache_archer()
{
	...
	precache_model("models/akarrow2.mdl");
	...
	precache_sound ("archer/arrowg2.wav");
...
void precache_bishop()
{
	...
	//precache_model ("models/dark_bishop_proj.mdl");
	precache_model ("models/grn.spr");
	precache_model ("models/bishop_proj.mdl");
	precache_model ("models/grndie.spr");
	precache_model ("models/grndth.spr");
	//precache_model ("models/purplexp.spr");
	
	precache_sound ("bishop/death.wav");
	precache_sound ("bishop/atk.wav");
	precache_sound ("bishop/pain.wav");
	precache_sound ("bishop/blur.wav");
	precache_sound ("bishop/sight.wav");
	precache_sound ("death_knight/gib2.wav");
	
	precache_sound ("bishop/tdam.wav");
	precache_sound ("bishop/idle.wav");
	precache_sound ("bishop/idle2.wav");
}

void precache_disciple()
{
	precache_model ("models/disciple.mdl");
	//precache_model ("models/disciple_proj.mdl");
	//precache_model ("models/grn.spr");
	precache_model ("models/purplfire.mdl");
	precache_model ("models/purpldie.spr");
	precache_model ("models/purplexp.spr");
...
{
	precache_model ("models/footsoldier.mdl");
	
	//GIBS
	precache_model ("models/footsoldierhd.mdl");
	precache_model ("models/footsoldiersplit.mdl");
	precache_model ("models/footsoldierhalf.mdl");
	precache_model ("models/footsoldierdecap.mdl");
	precache_model ("models/footsoldierleg.mdl");
	precache_model ("models/footsoldierarm.mdl");
	precache_model ("models/footsoldieraxe.mdl");
	...
	precache_sound ("death_knight/idle.wav");
}
...
{
	precache_model("models/ZombiePal.mdl");
	precache_model("models/ZombiePal_arm.mdl");
	precache_model("models/ZombiePal_leg.mdl");
	precache_model("models/ZombiePal_nohd.mdl");
	precache_model("models/ZombiePal_hd.mdl");

	precache_sound ("undying/upain.wav");
	precache_sound ("undying/uattack.wav");
	precache_sound ("undying/udeath.wav");
